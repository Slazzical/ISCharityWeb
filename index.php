...
<head>
    <meta charset="utf-8">
    <title>Donation System - Administrator Module</title>
...
<br>
<br>
<button class="btn btn-dark btn-block border-0 py-3" onclick="printData();">Print Report</button>
<br>
                </div>
            </div>
        </div>
...
<?php
$sql = "SELECT `Donation_ID`, `Description`, `Message`, `Type`, `Image`, `User_ID`, `Quantity`, `Status`, `Driver_ID`, `Charity_ID` FROM `donations`";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="card border-0">
                        <div class="card-header bg-light text-center p-4">
                            <h1 class="m-0">Sign Up A User</h1>
                        </div>
                        <div class="card-body rounded-bottom bg-primary p-5">
                            <form action="php/functions.php" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    <input type="text" class="form-control border-0 p-4" name="fname" placeholder="Your Fullname" required="required" />
                                </div>
                                <div class="form-group">
                                    <input type="text" minlength="13" name="phone" class="form-control border-0 p-4" placeholder="Your Phone Number" required="required" />
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control border-0 p-4" placeholder="Your Email Address" required="required" />
                                </div>
                                <div class="form-group">
                                    <label style="color: white;">Profile Picture:</label>
                                    <br>
                                    ...
                                    <select class="custom-select border-0 px-4" style="height: 47px;" name="type" required>
                                        ...
                                        <option value="Charity Owner">Charity Owner</option>
                                    </select>
                                </div>
                                <div class="form-group" style="color: white;">
                                    <input type="password" name="password" id="pass" class="form-control border-0 p-4" placeholder="Your Password" required="required" />
